...
const PanelCard = ({ data, onClose, onNav }) => {
  ...
  return (
    <div className="panel-wrap">
      <button className="panel-nav panel-nav--prev" onClick={() => onNav?.(-1)} ref={(el) => { itemsRef.current[7] = el; }} style={hiddenStyle}>
      ...
      <button className="panel-nav panel-nav--next" onClick={() => onNav?.(1)} ref={(el) => { itemsRef.current[8] = el; }} style={hiddenStyle}>
