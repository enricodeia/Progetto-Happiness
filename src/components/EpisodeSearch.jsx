    ...
    <div className="ep-search" ref={wrapRef} style={{ width: open ? 280 : 40 }}>
      {!open ? (
        <button className="ep-search__btn" onClick={handleOpen}>
          <svg width="16" height="16" viewBox="0 0 20 20" fill="white"><path d="M14 8C14 4.68629 11.3137 2 8 2C4.68629 2 2 4.68629 2 8C2 11.3137 4.68629 14 8 14C11.3137 14 14 11.3137 14 8ZM16 8C16 9.8486 15.3703 11.5487 14.3174 12.9033L19.707 18.293C20.0976 18.6835 20.0976 19.3165 19.707 19.707C19.3165 20.0976 18.6835 20.0976 18.293 19.707L12.9033 14.3174C11.5487 15.3703 9.8486 16 8 16C3.58172 16 0 12.4183 0 8C0 3.58172 3.58172 0 8 0C12.4183 0 16 3.58172 16 8Z"/></svg>
        </button>
      ) : (
        <div className="ep-search__field">
          <svg className="ep-search__icon" width="14" height="14" viewBox="0 0 20 20" fill="white"><path d="M14 8C14 4.68629 11.3137 2 8 2C4.68629 2 2 4.68629 2 8C2 11.3137 4.68629 14 8 14C11.3137 14 14 11.3137 14 8ZM16 8C16 9.8486 15.3703 11.5487 14.3174 12.9033L19.707 18.293C20.0976 18.6835 20.0976 19.3165 19.707 19.707C19.3165 20.0976 18.6835 20.0976 18.293 19.707L12.9033 14.3174C11.5487 15.3703 9.8486 16 8 16C3.58172 16 0 12.4183 0 8C0 3.58172 3.58172 0 8 0C12.4183 0 16 3.58172 16 8Z"/></svg>
          <input
            ref={inputRef}
